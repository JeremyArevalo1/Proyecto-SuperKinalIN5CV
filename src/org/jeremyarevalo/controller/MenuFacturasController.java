...
public class MenuFacturasController implements Initializable {
    ...
    public void cargarDatosEditar(){
        Facturas fa = (Facturas)tblFacturas.getSelectionModel().getSelectedItem();
        if(fa != null){
    ...
    public int obtenerIndexCliente(){
        ...
        for(int i = 0 ; i <= cmbCliente.getItems().size() ; i++){
            ...
            String clienteTbl = ((Facturas)tblFacturas.getSelectionModel().getSelectedItems()).getCliente();
    ...
    public int obtenerIndexEmpleado(){
        ...
        for(int i = 0 ; i <= cmbEmpleado.getItems().size() ; i++){
            ...
            String empleadoTbl = ((Facturas)tblFacturas.getSelectionModel().getSelectedItems()).getEmpleado();
    ...
    public ObservableList<Facturas> listarFacturas(){
        ...
        try{
            ...
            while(resultset.next()){
                ...
                facturas.add(new Facturas(facturaId, fecha.toLocalDate(), hora.toLocalTime(), total, cliente, empleado));
            }
    ...
    public void editarFacturas(){
        try{
            ...
            statement.setInt(6, ((Empleados)cmbEmpleado.getSelectionModel().getSelectedItem()).getEmpleadoId());
            statement.execute();
        }catch(SQLException e){
            System.out.println(e.getMessage());
        }finally{
